...
#define REG_DISPCNT     (*(volatile uint16_t *)REG_ADDR_DISPCNT)
#define REG_DISPSTAT    (*(volatile uint16_t *)REG_ADDR_DISPSTAT)
#define REG_VCOUNT      (*(volatile uint16_t *)REG_ADDR_VCOUNT)
#define REG_BG0CNT      (*(volatile uint16_t *)REG_ADDR_BG0CNT)
#define REG_BG1CNT      (*(volatile uint16_t *)REG_ADDR_BG1CNT)
#define REG_BG2CNT      (*(volatile uint16_t *)REG_ADDR_BG2CNT)
#define REG_BG3CNT      (*(volatile uint16_t *)REG_ADDR_BG3CNT)
#define REG_BG0HOFS     (*(volatile uint16_t *)REG_ADDR_BG0HOFS)
#define REG_BG0VOFS     (*(volatile uint16_t *)REG_ADDR_BG0VOFS)
#define REG_BG1HOFS     (*(volatile uint16_t *)REG_ADDR_BG1HOFS)
#define REG_BG1VOFS     (*(volatile uint16_t *)REG_ADDR_BG1VOFS)
#define REG_BG2HOFS     (*(volatile uint16_t *)REG_ADDR_BG2HOFS)
#define REG_BG2VOFS     (*(volatile uint16_t *)REG_ADDR_BG2VOFS)
#define REG_BG3HOFS     (*(volatile uint16_t *)REG_ADDR_BG3HOFS)
#define REG_BG3VOFS     (*(volatile uint16_t *)REG_ADDR_BG3VOFS)
#define REG_BG2PA       (*(volatile uint16_t *)REG_ADDR_BG2PA)
#define REG_BG2PB       (*(volatile uint16_t *)REG_ADDR_BG2PB)
#define REG_BG2PC       (*(volatile uint16_t *)REG_ADDR_BG2PC)
#define REG_BG2PD       (*(volatile uint16_t *)REG_ADDR_BG2PD)
#define REG_BG2X        (*(volatile uint32_t *)REG_ADDR_BG2X)
#define REG_BG2X_L      (*(volatile uint16_t *)REG_ADDR_BG2X_L)
#define REG_BG2X_H      (*(volatile uint16_t *)REG_ADDR_BG2X_H)
#define REG_BG2Y        (*(volatile uint32_t *)REG_ADDR_BG2Y)
#define REG_BG2Y_L      (*(volatile uint16_t *)REG_ADDR_BG2Y_L)
#define REG_BG2Y_H      (*(volatile uint16_t *)REG_ADDR_BG2Y_H)
#define REG_BG3PA       (*(volatile uint16_t *)REG_ADDR_BG3PA)
#define REG_BG3PB       (*(volatile uint16_t *)REG_ADDR_BG3PB)
#define REG_BG3PC       (*(volatile uint16_t *)REG_ADDR_BG3PC)
#define REG_BG3PD       (*(volatile uint16_t *)REG_ADDR_BG3PD)
#define REG_BG3X        (*(volatile uint32_t *)REG_ADDR_BG3X)
#define REG_BG3X_L      (*(volatile uint16_t *)REG_ADDR_BG3X_L)
#define REG_BG3X_H      (*(volatile uint16_t *)REG_ADDR_BG3X_H)
#define REG_BG3Y        (*(volatile uint32_t *)REG_ADDR_BG3Y)
#define REG_BG3Y_L      (*(volatile uint16_t *)REG_ADDR_BG3Y_L)
#define REG_BG3Y_H      (*(volatile uint16_t *)REG_ADDR_BG3Y_H)
#define REG_WIN0H       (*(volatile uint16_t *)REG_ADDR_WIN0H)
#define REG_WIN1H       (*(volatile uint16_t *)REG_ADDR_WIN1H)
#define REG_WIN0V       (*(volatile uint16_t *)REG_ADDR_WIN0V)
#define REG_WIN1V       (*(volatile uint16_t *)REG_ADDR_WIN1V)
#define REG_WININ       (*(volatile uint16_t *)REG_ADDR_WININ)
#define REG_WINOUT      (*(volatile uint16_t *)REG_ADDR_WINOUT)
#define REG_MOSAIC      (*(volatile uint16_t *)REG_ADDR_MOSAIC)
#define REG_BLDCNT      (*(volatile uint16_t *)REG_ADDR_BLDCNT)
#define REG_BLDALPHA    (*(volatile uint16_t *)REG_ADDR_BLDALPHA)
#define REG_BLDY        (*(volatile uint16_t *)REG_ADDR_BLDY)
...
#define REG_DMA0SAD     (*(volatile uint32_t *)REG_ADDR_DMA0SAD)
#define REG_DMA0DAD     (*(volatile uint32_t *)REG_ADDR_DMA0DAD)
#define REG_DMA0CNT     (*(volatile uint32_t *)REG_ADDR_DMA0CNT)
#define REG_DMA0CNT_L   (*(volatile uint16_t *)REG_ADDR_DMA0CNT_L)
#define REG_DMA0CNT_H   (*(volatile uint16_t *)REG_ADDR_DMA0CNT_H)

#define REG_DMA1SAD     (*(volatile uint32_t *)REG_ADDR_DMA1SAD)
#define REG_DMA1DAD     (*(volatile uint32_t *)REG_ADDR_DMA1DAD)
#define REG_DMA1CNT     (*(volatile uint32_t *)REG_ADDR_DMA1CNT)
#define REG_DMA1CNT_L   (*(volatile uint16_t *)REG_ADDR_DMA1CNT_L)
#define REG_DMA1CNT_H   (*(volatile uint16_t *)REG_ADDR_DMA1CNT_H)

#define REG_DMA2SAD     (*(volatile uint32_t *)REG_ADDR_DMA2SAD)
#define REG_DMA2DAD     (*(volatile uint32_t *)REG_ADDR_DMA2DAD)
#define REG_DMA2CNT     (*(volatile uint32_t *)REG_ADDR_DMA2CNT)
#define REG_DMA2CNT_L   (*(volatile uint16_t *)REG_ADDR_DMA2CNT_L)
#define REG_DMA2CNT_H   (*(volatile uint16_t *)REG_ADDR_DMA2CNT_H)

#define REG_DMA3SAD     (*(volatile uint32_t *)REG_ADDR_DMA3SAD)
#define REG_DMA3DAD     (*(volatile uint32_t *)REG_ADDR_DMA3DAD)
#define REG_DMA3CNT     (*(volatile uint32_t *)REG_ADDR_DMA3CNT)
#define REG_DMA3CNT_L   (*(volatile uint16_t *)REG_ADDR_DMA3CNT_L)
#define REG_DMA3CNT_H   (*(volatile uint16_t *)REG_ADDR_DMA3CNT_H)

#define REG_TMCNT(n)    (*(volatile uint32_t *)(REG_ADDR_TMCNT + ((n) * 4)))
#define REG_TMCNT_L(n)  (*(volatile uint16_t *)(REG_ADDR_TMCNT_L + ((n) * 4)))
#define REG_TMCNT_H(n)  (*(volatile uint16_t *)(REG_ADDR_TMCNT_H + ((n) * 4)))
#define REG_TM0CNT      (*(volatile uint32_t *)REG_ADDR_TM0CNT)
#define REG_TM0CNT_L    (*(volatile uint16_t *)REG_ADDR_TM0CNT_L)
#define REG_TM0CNT_H    (*(volatile uint16_t *)REG_ADDR_TM0CNT_H)
#define REG_TM1CNT      (*(volatile uint32_t *)REG_ADDR_TM1CNT)
#define REG_TM1CNT_L    (*(volatile uint16_t *)REG_ADDR_TM1CNT_L)
#define REG_TM1CNT_H    (*(volatile uint16_t *)REG_ADDR_TM1CNT_H)
#define REG_TM2CNT      (*(volatile uint32_t *)REG_ADDR_TM2CNT)
#define REG_TM2CNT_L    (*(volatile uint16_t *)REG_ADDR_TM2CNT_L)
#define REG_TM2CNT_H    (*(volatile uint16_t *)REG_ADDR_TM2CNT_H)
#define REG_TM3CNT      (*(volatile uint32_t *)REG_ADDR_TM3CNT)
#define REG_TM3CNT_L    (*(volatile uint16_t *)REG_ADDR_TM3CNT_L)
#define REG_TM3CNT_H    (*(volatile uint16_t *)REG_ADDR_TM3CNT_H)

#define REG_SIOCNT      (*(volatile uint16_t *)REG_ADDR_SIOCNT)
#define REG_SIODATA8    (*(volatile uint16_t *)REG_ADDR_SIODATA8)
#define REG_SIODATA32   (*(volatile uint32_t *)REG_ADDR_SIODATA32)
#define REG_SIOMLT_SEND (*(volatile uint16_t *)REG_ADDR_SIOMLT_SEND)
#define REG_SIOMLT_RECV (*(volatile uint64_t *)REG_ADDR_SIOMLT_RECV)
#define REG_SIOMULTI0   (*(volatile uint16_t *)REG_ADDR_SIOMULTI0)
#define REG_SIOMULTI1   (*(volatile uint16_t *)REG_ADDR_SIOMULTI1)
#define REG_SIOMULTI2   (*(volatile uint16_t *)REG_ADDR_SIOMULTI2)
#define REG_SIOMULTI3   (*(volatile uint16_t *)REG_ADDR_SIOMULTI3)

#define REG_KEYINPUT    (*(volatile uint16_t *)REG_ADDR_KEYINPUT)
#define REG_KEYCNT      (*(volatile uint16_t *)REG_ADDR_KEYCNT)

#define REG_RCNT        (*(volatile uint16_t *)REG_ADDR_RCNT)

#define REG_IME         (*(volatile uint16_t *)REG_ADDR_IME)
#define REG_IE          (*(volatile uint16_t *)REG_ADDR_IE)
#define REG_IF          (*(volatile uint16_t *)REG_ADDR_IF)

#define REG_WAITCNT     (*(volatile uint16_t *)REG_ADDR_WAITCNT)
